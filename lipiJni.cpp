...
#define TAG "HandWriting_Input_Jni"
...
{
    LOGD("JNI_OnLoad Jni_HandWriting_Input\n");
...
{
    LOGD("JNI_OnUnload Jni_HandWriting_Input\n");
}


void JNICALL Java_com_gdbbk_dw_handwritinginput_LipiTKJNIInterface_initializeNative(JNIEnv *env, 
																 jclass this_object, 
																 jstring lipiDirectory,
																 jstring lipiProject)
{
	int result;
	LOGD("Java_com_canvas_LipiTKJNIInterface_initializeNative\n");
	char* lipitkLocation = (char*)env->GetStringUTFChars(lipiDirectory, NULL);

	LOGD("lipiDirectory:%s\n", lipitkLocation);
...
jobjectArray 
	JNICALL Java_com_gdbbk_dw_handwritinginput_LipiTKJNIInterface_recognizeNative(JNIEnv *env,
															   jclass this_object,
															   ...
															   jint NumStrokes)
{
	...
	try
	{
		jclass strokeClass = env->FindClass("com/gdbbk/dw/handwritinginput/Stroke");
		if(strokeClass == NULL)
		...
		jclass resultClass = env->FindClass("com/gdbbk/dw/handwritinginput/LipitkResult");
		if(resultClass == NULL)
